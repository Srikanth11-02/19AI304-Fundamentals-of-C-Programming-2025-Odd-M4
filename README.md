...
void validateDate() { int dd, mm, yy; int valid = 1;
...
int main() { validateDate(); return 0; }
```
# Output:
<img width="421" height="224" alt="image" src="https://github.com/user-attachments/assets/c5dff81b-2570-4297-8db7-d174d1722280" />
...
```
# Output:
<img width="326" height="246" alt="image" src="https://github.com/user-attachments/assets/0ecb649b-fc8c-4104-9b3a-90ba0aea10dc" />
...
```
# Output:
<img width="665" height="230" alt="image" src="https://github.com/user-attachments/assets/3ea1a0fb-3ee6-40bf-8333-93d44b148b59" />
...
```
# Output:
<img width="517" height="90" alt="image" src="https://github.com/user-attachments/assets/39dd15be-d423-4a54-8671-4a771b71830b" />
...
```
# Output:
<img width="510" height="209" alt="image" src="https://github.com/user-attachments/assets/fcfa5de2-a524-43ca-854a-fdd1786ab3cd" />
